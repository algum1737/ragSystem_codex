...
| 평가셋 일반화 검토 | 현재 10개 케이스 과적합 여부 점검 | 낮음 | 진행 예정 |
| 이용약관 문서 확대 | 다문서 환경 검색 품질 검증 | 낮음 | 후속 후보 |
...
*최종 업데이트: 2026-05-15 — 최신 리포트 `eval/results/eval_20260515_135903.json`, accuracy/faithfulness/not_found 현재 평가셋 상한 달성*

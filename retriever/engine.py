...
3. 첫 줄부터 질문에 직접 답하는 핵심만 최대 4개 bullet로 작성하세요.
4. 각 bullet은 1문장으로 제한하세요.
5. 같은 의미의 조건이나 서비스별 유사 처리는 하나의 bullet로 합치세요.
6. 질문과 직접 관련 없는 비용, 광고, 사용기간, 청약철회, 환불, 보상 세부사항, 일반 안내, 배경 설명은 참고 문서에 있어도 제외하세요.
7. 조건, 제한, 예외, 통지 시점을 묻는 질문에서는 참고 문서에 있는 예외 조건을 생략하지 마세요.
   - 사전/사후 통지 예외가 있으면 별도 bullet로 작성하세요.
8. "문서에서 확인되지 않습니다", "확인되지 않은 항목" 같은 미확인 문장은 쓰지 마세요.
9. 마지막 줄에 "근거: 문서명1, 문서명2" 형식으로 가장 중요한 출처명을 최대 3개만 적으세요.
10. 근거에는 참고 문서의 "출처:" 뒤에 있는 실제 문서명만 그대로 쓰고, "문서1", "문서2", "[1]" 같은 번호 별칭은 쓰지 마세요.
11. 원문을 길게 인용하거나 같은 내용을 반복하지 마세요.
